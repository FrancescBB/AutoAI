...
const Contact = () => {
    useDocTitle('AutoAI - Automatiza tu negocio');
            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full bg-white py-12 lg:py-24 ">
                ...
                <form onSubmit={sendEmail}>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <a href="https://www.linkedin.com/in/francesc-ballester-bernabeu-6699ab277/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8  mx-1 text-center pt-1">
